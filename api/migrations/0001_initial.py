# Generated by Django 4.1.2 on 2022-12-13 02:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('followers', models.ManyToManyField(blank=True, null=True, related_name='usersFollowing', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ctg_following', models.ManyToManyField(blank=True, null=True, related_name='categoriesFollowing', to='api.category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(default='', max_length=750)),
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('isActive', models.BooleanField(default=True)),
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='postCreator', to='api.profile')),
                ('dislikes', models.ManyToManyField(blank=True, null=True, related_name='dislikedPost', to='api.profile')),
                ('likes', models.ManyToManyField(blank=True, null=True, related_name='likedPost', to='api.profile')),
            ],
        ),
        migrations.CreateModel(
            name='Like',
